...
public:
    ...
    std::vector<CopterState<Dim>> getExpandStates() {
        return this->expanded_iter_states;
    }
    std::vector<std::vector<Primitive<Dim>>> getExpandPrimitive() {
        return this->expanded_iter_prs;
    }
    std::vector<std::vector<int>> getExpandedActions() {
        return this->expanded_iter_actions;
    }

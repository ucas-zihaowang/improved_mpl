...
{
    std::string name = "batchtest_slplanner_demo_corridor_node";
    ...
    {
        CopterState2d start( cp.cm, cp.yaw_use, instance2.getStarts(i).head<2>() );
        CopterState2d goal( cp.cm, cp.yaw_use, instance2.getGoals(i).head<2>() );
